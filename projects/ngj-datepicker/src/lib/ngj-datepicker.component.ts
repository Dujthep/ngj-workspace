...
const NGJ_DATETIME_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => NgjDatepickerComponent),
  multi: true
};

@Component({
  selector: 'ngj-datepicker',
  template: `
  ...
  `,
  styles: [],
  providers: [NGJ_DATETIME_VALUE_ACCESSOR]
})
export class NgjDatepickerComponent implements ControlValueAccessor, AfterViewInit {
